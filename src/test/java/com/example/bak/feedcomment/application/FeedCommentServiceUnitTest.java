...
class FeedCommentServiceUnitTest {
    ...
    @Nested
    @DisplayName("FeedCommentQueryService")
    class FeedCommentQueryServiceTest {

        private FeedCommentQueryService feedCommentQueryService;
        private FeedCommentRepositoryStub feedCommentRepository;

        @BeforeEach
        void setUp() {
            feedCommentRepository = new FeedCommentRepositoryStub();
            feedCommentQueryService = new FeedCommentQueryService(feedCommentRepository);
        }
        ...
        void getComments_success() {
            ...
            var comments = feedCommentQueryService.getComments(EXISTING_FEED_ID);
